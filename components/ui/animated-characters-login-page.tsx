...
export default function AnimatedCharactersLoginPage({ onLogin, onNavigateToSignup }: AnimatedCharactersLoginPageProps) {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative flex flex-col justify-between bg-black p-8 lg:p-12 text-white overflow-hidden min-h-[400px] lg:min-h-screen">
        ...
        <div className="relative z-20 flex items-end justify-center flex-1 lg:h-[500px]">
          {/* Cartoon Characters - Scaled for mobile */}
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm text-white/60 hidden lg:flex">
        ...
        {/* Decorative elements - Neutral colors */}
        <div className="absolute top-1/4 right-1/4 size-64 bg-zinc-800/20 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 size-96 bg-zinc-800/10 rounded-full blur-3xl" />
      </div>

      {/* Right Login Section - Semi-transparent with Matrix Effect */}
      <div className="flex items-center justify-center p-8 bg-black/60 backdrop-blur-xl relative z-10 overflow-hidden">
        <CyberMatrixHero className="absolute inset-0 z-0 opacity-50" />
        <div className="w-full max-w-[420px] relative z-10">
          {/* Mobile Logo - Hidden now since we show the left panel */}
          <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-6 hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-medium text-zinc-300">Username or Email</Label>
              <Input
                id="email"
                type="text"
                ...
                required
                className="h-12 bg-black/40 border-white/10 focus:border-primary text-white placeholder:text-zinc-600"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-black/40 border-white/10 focus:border-primary text-white placeholder:text-zinc-600"
                />
                <button
                  type="button"
          ...
          <div className="text-center text-sm text-zinc-500 mt-8">
            ...
            <button onClick={onNavigateToSignup} className="text-white font-medium hover:underline">
              Sign Up
            </button>
          </div>
        </div>
